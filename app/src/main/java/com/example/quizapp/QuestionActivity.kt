...
class QuestionActivity : AppCompatActivity() {
        ...
        submit.setOnClickListener {
            if(selectedOption!=0){
                ...
                if(selectedOption!=question.correct_ans){
                  setColor(selectedOption,R.drawable.wrong_selected_question)
                }else{
                    score++
                }
                setColor(question.correct_ans,R.drawable.correct_selected_question)
    ...
    fun setOptionStyle(){
        ...
        for (op in optionList){
            ...
            op.background=ContextCompat.getDrawable(this,R.drawable.queston_option)
